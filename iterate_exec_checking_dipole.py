...
from decimal import Decimal, getcontext
#this script runs exec_checking_dipole.py sequentially
...
for TStr in TStrAll:
    try:
        ...
        current_process = subprocess.Popen(
            ["python3", "exec_checking_dipole.py", TStr, str(N), str(startingFileIndSuggest), str(init_path)]
        )
